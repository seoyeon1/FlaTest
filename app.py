...
def result():
	if request.method == 'POST':#지금은 get인데 시간 나면 post로 바꿀 예정

		origin = request.form["original"] #사용자가 입력한 값을 user에 저장
		summary = origin + 'This is the Space for summary results' #요약 결과를 담을 변수
